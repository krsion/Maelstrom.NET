...
internal class Counter(ILogger<Counter> logger, IReceiver receiver, ISender sender) : MaelstromNode(logger, receiver, sender)
{
    ...
    public async Task HandleRead(Message message)
    {
        ...
        await ReplyAsync(message, new KvReadOk<int>(latestValue));
    }
