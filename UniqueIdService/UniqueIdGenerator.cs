...
internal class UniqueIdGenerator(ILogger<UniqueIdGenerator> logger, IReceiver receiver, ISender sender) : MaelstromNode.MaelstromNode(logger, receiver, sender)
{
